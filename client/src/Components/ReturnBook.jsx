...
if(borrowed===''||fromDate===''||toDate===''){
  setErr("Borrowed name, From date , To date must be provided")
    ...
    axios.post(`http://localhost:4000/return`,{obj}).then(res=>console.log(res))
  }
  }
  return (
    <div className="container">
      ...
      <br />
        ...
        <form action="">
          ...
          <div className="row">
            <div className="col-8">
            <label className="form-label">Book returned by:</label>
          ...
          <br />
          <button type="submit" className="btn btn-primary" onClick={returnbook}>Return Book</button>
        </form>
    </div>
  )
}
